...
trait HasAudience
{
     ...
     * Range: Object | Link
     */
    public function withAudience(BaseObject|Link|RemoteNode|string|Collection $value): self
    {
        ...
        return $this->set('https://www.w3.org/ns/activitystreams#audience', $collection);
    }
}
